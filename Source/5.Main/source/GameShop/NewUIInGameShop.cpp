...
{		
	...
	for(int i=0 ; i<g_InGameShopSystem->GetSizePackageAsDisplayPackage() ; i++ )
	{
		...
		{
			RenderItem3D(iPosX-25, iPosY, IGS_ITEMRENDER_POS_WIDTH, IGS_ITEMRENDER_POS_HEIGHT, g_InGameShopSystem->GetPackageItemCode(i), 0, 0, 0, true);
		}
		else
		{
...
bool CNewUIInGameShop::UpdateBanner()
{
	...
	if( (SEASON3B::IsPress(VK_LBUTTON))
		&& (SEASON3B::CheckMouseIn(IMAGE_IGS_BANNER_POS_X + DisplayWinExt, IMAGE_IGS_BANNER_POS_Y, IMAGE_IGS_BANNER_WIDTH, IMAGE_IGS_BANNER_HEIGHT)))
	{
