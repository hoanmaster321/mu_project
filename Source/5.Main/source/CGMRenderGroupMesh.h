...
public:
	...
	bool RenderSetEffect(int modelType, BMD* pModel, OBJECT* pObject, float Alpha, int RenderType, int Texture);

	void RenderSet(RENDER_MESH_EFFECT* b, BMD* pModel, OBJECT* pObject);
