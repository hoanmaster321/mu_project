...
private:
	...
	int GetTextureForMesh(Mesh_t* m, int MeshTexture);
	void UpdateLightTransform(int i, Mesh_t* m);
	int GetRenderMode(int RenderFlag);
	void SetupRenderingState(int RenderFlag, float Alpha, int RenderMode, int Texture);
	void ConfigureColorRendering(int RenderFlag, float Alpha);
	void RenderTriangle(Mesh_t* m, int triangleIndex, bool EnableLight, float Alpha, int RenderMode, float BlendMeshTexCoordU, float BlendMeshTexCoordV, int i);
	void RenderTextureTriangle(Triangle_t* tp, int k, bool EnableLight, float Alpha, int i);
	void RenderChromeTriangle(Triangle_t* tp, int k, float Alpha, int i);
};
